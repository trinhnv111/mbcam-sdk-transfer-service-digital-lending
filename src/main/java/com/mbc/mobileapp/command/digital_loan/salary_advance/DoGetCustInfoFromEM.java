...
//
            ...
            if (emResponse.getStatus() == null || emResponse.getStatus() != 0) {
                ...
                // Map specific eMoney errors to MBC Response Codes from unified Constant Map
                ResponseCode errorCode = SalaryAdvanceConstant.EMONEY_ERROR_MAP.get(emCode);
                if (errorCode == null) {
                    if (emMsg.contains("Customer does not receive salary")) {
