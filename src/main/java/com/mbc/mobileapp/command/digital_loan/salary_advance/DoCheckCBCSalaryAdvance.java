...
public class DoCheckCBCSalaryAdvance implements Command {
    ...
    public boolean execute(Context ctx) throws Exception {
        ...
        try {
            ...
            log.info("[DoCheckCBCSalaryAdvance] CBC REQUEST - requestId:{}, idNumber:{}, requestBy:{}, appCode:{}",
                    request.getRequestId(), idNumber, cbcRequestBy, cbcAppCode);
            ...
            log.info("[DoCheckCBCSalaryAdvance] CBC RESPONSE - requestId:{}, raw:{}",
                    request.getRequestId(), JSON.stringify(cbcResponse));
