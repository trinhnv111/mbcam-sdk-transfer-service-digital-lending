...
//            }
    ...
    public ExecuteT24Output<LdFeeData> getLdFee(String custId, String requestId) {
        ...
        String channel = SalaryAdvanceConstant.CHANNEL;
        String product = SalaryAdvanceConstant.PRODUCT;
        String subProduct = SalaryAdvanceConstant.SUB_PRODUCT;
        String partnerCode = SalaryAdvanceConstant.PARTNER_CODE;
