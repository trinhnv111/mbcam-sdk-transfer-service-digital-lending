...
public interface DigitalLoanService {
    ...
    ValidDisbursementResponse validDisbursement(Request request, CustInfo cust);

    DisbursementResponse<Object> disbursement(Request request, CustInfo cust, TokenOtp tokenOtp);
}
